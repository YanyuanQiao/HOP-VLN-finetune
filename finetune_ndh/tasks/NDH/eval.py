...
class Evaluation(object):
    ...
    def score(self, output_file):
        ...
        sc_idx = np.array([i < self.error_margin for i in self.scores['nav_errors']])
        ...
        score_summary ={
            ...
            'sc_dr': sum(np.array(self.scores['dist_to_end_reductions'])[sc_idx]) / float(len(self.scores['dist_to_end_reductions']))
        }
